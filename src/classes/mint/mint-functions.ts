...
export const checkStatusAllExecutionsForModel = async (
    ...
    let runtimeInfos: any = await fetchWingsRunsStatuses(
    ...
    while (true) {
        ...
        let finished_executions = changed_executions.filter(
